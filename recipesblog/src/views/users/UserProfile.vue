                ...
                <div class='columns is-mobile is-multiline'>
                    ...
                    <div class='column is-4-tablet is-10-mobile name'>
                        <p>
                            ...
                            <br>
                            <button class='button is-primary is-outlined' href='#' id='edit-preferences'
                                style='margin: 5px 0'>
                                Edit
                            </button>
                            <br>
                        ...
                        <div class='card-content'>
                            <div class='content'>
                                ...
                                <p>Personal Notes on the Property (can be edited and saved automatically by clicking in
                                    and clicking out of text area) - these are unique to the user - they will show up as
                                    part of a saved listings' info here - but adding notes to a property does not
                                    automatically create a saved listing. Likewise, removing this proeprty from saved
                                    listings does not auto remove the notes.</p>
                            </div>
                        </div>
